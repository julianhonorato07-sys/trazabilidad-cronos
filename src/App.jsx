...
const TABS = [
  ...
  { id: 'oleo', label: 'OLEO', icon: 'auto', comp: Oleo },
...
const ROL_LABEL = { revision: 'Revisión final', box: 'Box', oleo: 'OLEO', supervisor: 'Supervisión', cabina: 'Cabina', cajas: 'Cajas' }
const ROL_TAB = { revision: 'registrar', box: 'box', oleo: 'oleo', supervisor: 'panel', cabina: 'cabina', cajas: 'cajas' }
