import { catalogo, colorHex, colorNombre, ESTADOS } from '../data/repo'
...
export function OperarioPicker({ roles, titulo, onPick, onClose }) {
  ...
  return (
    <Modal onClose={onClose}>
      ...
      <p className="sub">La acción queda a nombre de quien la ejecuta.</p>
      <div className="grid2">
        {lista.map((o) => (
          <button key={o.id} className="btn op-btn" onClick={() => onPick(o.id)}>
